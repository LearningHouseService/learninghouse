...
from learninghouse.services.configuration import (
...
@brain_router.get(
    ...
    responses={200: {"description": "All configured brains"}},
)
...
router = APIRouter(
    tags=["configuration"], dependencies=[Depends(auth_service().protect_admin)]
)
